		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 content">
				...
				<div class="questions">
					...
					<p class="answer">My favorite programming language is Java! I have taken a few classes focusing on data structures and software design using this language. I also have some experience from classes that used C and JavaScript. I look forward to start working on some of my own programming projects soon outside of my classes. </p>
